...
exports.adminLoggedin = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const admin_1 = __importDefault(require("../model/admin"));
const dotenv = __importStar(require("dotenv"));
dotenv.config();
const adminLoggedin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (token) {
        try {
            ...
            const adminId = decoded === null || decoded === void 0 ? void 0 : decoded.userId;
...
exports.adminLoggedin = adminLoggedin;
