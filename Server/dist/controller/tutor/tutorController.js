...
exports.activateQuiz = exports.removeQuiz = exports.editProfilePhoto = exports.resetPassword = exports.resetPasswordSentOtp = exports.tutorEditedProfile = exports.tutorProfile = exports.enrolledStudents = exports.getAllLessons = exports.editCourseList = exports.getEditCourseList = exports.getCourseList = exports.disableLesson = exports.activateLesson = exports.AddQuiz = exports.addLesson = exports.addCourse = exports.getCategory = exports.login = exports.signUp = exports.sendOtp = void 0;
...
const sendOtp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const phonefind = yield tutor_1.default.findOne({ phone });
...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const phone = (_a = globalData.tutor) === null || _a === void 0 ? void 0 : _a.phone;
        yield axios_1.default.post(`${BaseUrl}/otp/verifymobileotp`, {
            phone,
            verificationCode,
        });
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tutorPassword = yield tutor_1.default.findOneAndUpdate({ phone }, {
