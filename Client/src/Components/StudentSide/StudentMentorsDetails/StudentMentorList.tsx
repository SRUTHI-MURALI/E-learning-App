...
function StudentMentorList({studentData}) {
    ...
    if (tutorID) {
     ...
     await generateToken('https://nextjs-token.vercel.app/api', studentID).then((res) => {
...
<div className="studentCallContainer" ref={studentMeetingContainerRef} style={{ width: '100vw', height: '100vh' }}>
